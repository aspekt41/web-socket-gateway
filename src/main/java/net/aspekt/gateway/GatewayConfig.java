...
public class GatewayConfig {
    ...
    @XmlElements({
        @XmlElement(name = "websocket-server", type = WebSocketServerConfig.class, namespace = NAMESPACE),
        @XmlElement(name = "tcp-client", type = TcpClientConfig.class, namespace = NAMESPACE),
        @XmlElement(name = "tcp-server", type = TcpServerConfig.class, namespace = NAMESPACE),
        @XmlElement(name = "tcp-hub", type = TcpHubConfig.class, namespace = NAMESPACE),
        @XmlElement(name = "udp-multicast", type = UdpMulticastConfig.class, namespace = NAMESPACE),
    ...
    public List<TcpHubConfig> getTcpHubs() {
        return elements.stream()
                .filter(e -> e instanceof TcpHubConfig)
                .map(e -> (TcpHubConfig) e)
                .collect(Collectors.toList());
    }
