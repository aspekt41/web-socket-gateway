...
class TcpHubIntegrationTest {
    ...
    void dataFromOnClientBroadcastsToOthersNotSender() throws Exception {
        ...
        try {
            ...
            assertArrayEquals(DATA_FROM_A, readExact(clientB, DATA_FROM_A.length), "B should receive A's data");
            assertArrayEquals(DATA_FROM_A, readExact(clientC, DATA_FROM_A.length), "C should receive A's data");
            ...
            assertArrayEquals(DATA_FROM_B, readExact(clientA, DATA_FROM_B.length), "A should receive B's data");
            assertArrayEquals(DATA_FROM_B, readExact(clientC, DATA_FROM_B.length), "C should receive B's data");
    ...
    void dataIsAlsoForwardedToConfiguredTargets() throws Exception {
        ...
        try {
            ...
            assertArrayEquals(
                    DATA_FROM_A, readExact(clientB, DATA_FROM_A.length), "B should receive A's data via hub broadcast");

            // Backend should also receive it (forwarding target)
            assertArrayEquals(
                    DATA_FROM_A,
                    readExact(backendConn, DATA_FROM_A.length),
